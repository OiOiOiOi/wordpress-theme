...
<?php
	 ...
	 * posts that are in the Jobs category, when we're displaying
...
<?php /* How to display posts in the Job category. */ ?>

	<?php if ( in_category( _x('Jobs', 'Jobscategory slug') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class('jobs-item'); ?>>
