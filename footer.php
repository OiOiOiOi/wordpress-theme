...
// 	query about page content 
	...
	while ( have_posts() ) : the_post(); ?>	
				<div class="footerbox col-8 first" id="post-<?php the_ID(); ?>">
					...
					<img class="img-left" src="http://www.abctech-thailand.com/wp-content/themes/perspective/images/about_thumbnail.jpg"/>
					<p><?php the_excerpt(); ?></p>
				</div>
<?php endwhile; ?>
				...
				<div class="footerbox col-16">
					<h4><a title="contact us" rel="bookmark" href="/contact">Contact us</a></h4>
					<p>
